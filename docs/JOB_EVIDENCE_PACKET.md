...
| Knowledge engine fully drained across all 4 sports -- zero open hypotheses left | `domains/{basketball_nba,mlb,soccer,tennis}/knowledge/validation_ledger.jsonl` -- 151 combined rows counted directly (NBA 20: 8 confirmed/9 null/3 not-testable; MLB 35: 16 confirmed/5 null/8 not-testable/4 failed-replication/1 artifact/1 reject; soccer 43 as of 2026-07-10 HEAD-committed count, ledger keeps growing under the live autoloop cycle: 12 confirmed/22 null/8 not-testable/1 provisional; tennis 56: 35 confirmed/17 null/4 not-testable) | "Closed out every open mechanism hypothesis across four sports, not most of them -- with the majority (51/151) coming back honest NULLs, the expected shape of a real audit." |

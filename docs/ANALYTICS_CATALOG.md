...
| Microstructure closing decay | Brier/log-loss of consensus devigged market P(home) at T-24h/T-6h/T-1h/close, paired within-game | `analytics_showcase/out/micro_closing_decay.json` | `docs/img/micro_closing_decay.png` | Single capture window, provisional. WNBA sharpens toward close (Brier T-6h 0.2454 -> close 0.2280, n=30); soccer_intl flat and **UNDERPOWERED** (n=13); nba/mlb/soccer/tennis/kbo/npb **not_joinable** (no line_history<->outcome join). |

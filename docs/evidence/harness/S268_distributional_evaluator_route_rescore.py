"""Reproduce the sealed S268 construct and MLB distributional route artifacts."""
...
FIXTURE = Path("docs/evidence/harness/S268_distributional_evaluator_route_fixture_2026-09-04.json")
PAIRED = Path("docs/evidence/harness/S268_distributional_evaluator_route_mlb_paired_losses_2026-09-04.csv")

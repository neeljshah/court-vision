...
Source grep count: 43

Source file list:
- S06_stacker_result_2026-09-03.md
...
|---|---:|---:|---:|---:|---:|---:|---|
| S06_stacker_result_2026-09-03.md | 47104 | 158 | 296.610988 | +0.090156835811 | 0.042094316591 | 0.060079477584 | UNDERPOWERED |
...
| screen IDs | leading S-number could repeat | stem plus sorted per-file ordinal; duplicate stems add path SHA |
...
- Real-corpus counts can differ between this worktree and the landing main checkout; this worktree run has 43 screens and the known main count is 45.
...
Schema assertion: full additive fields are present and every screen_id is unique.

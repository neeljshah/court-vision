...
| INTELLIGENCE | accepted receipt -> composed response | `contract_client.answer` -> `resolver_registry.resolve` | CONNECTED (R1, R2, R4) | CONNECTED (R1, R2, R4) | yes -- three composed answers quote receipt, hash, basis, n, available CI and as-of |

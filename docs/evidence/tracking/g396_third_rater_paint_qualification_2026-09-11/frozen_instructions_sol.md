# G392 known-band control instruction (identical for both raters)
...
```
{
  "control_id": "G392_PRACTICE_001",
  "state": "VISIBLE",
  "reason": "white band on dark floor",
  "opened_path": "C:/.../G392_PRACTICE_001.png",
  "opened_width": 640,
  "opened_height": 540,
  "tile": 3,
  "offset": [1280, 0],
...
For steep diagonal bands, verify all three selected points lie on the same bright white centerline by inspecting the original-resolution pixels before recording coordinates.

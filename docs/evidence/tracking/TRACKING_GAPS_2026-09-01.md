...
| G11 | baseball | dominant_green scores 0 on night games (stadium lighting) -> pitch-view gate lighting-dependent | same | CONFIRMED by T5c: both night games ~0 pitch views over 12,000 frames; needs a lighting-robust pitch-view gate (HSV hue/sat not value; or dirt/grass boundary geometry) | 

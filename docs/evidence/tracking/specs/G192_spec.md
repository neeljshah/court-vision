GAP G192 | sport ncaa_basketball / wnba | worktree a6 | log g192_score_existing_homography
...
STOP and report FALSIFIED:
  ...
  - The decodes are **640x360**. The targets' `image_width`/`image_height` are 640/360.

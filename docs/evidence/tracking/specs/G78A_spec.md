GAP G78A | sport tennis | worktree a2 | log cx_g78a_resolve_uncertain  (CHUNK of G78 -- ONE CLIP ONLY)
...
**YOUR CLIP IS `tennis__tennis_10.mp4` AND NOTHING ELSE. It has 47 uncertain rows.**
WRITE YOUR RESULTS INCREMENTALLY to
docs/evidence/tracking/g65_ball_labels/resolved/tennis__tennis_10.csv, flushing after every 10 rows.

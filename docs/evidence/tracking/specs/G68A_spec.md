GAP G68A | sport basketball | worktree a2 | log cx_g68a_paint_labels  (CHUNK of G68 -- label ONLY the clips named below)
...
are exactly these and no others:
    ncaa_basketball__ncaa_basketball_IB-_u4gW3ds, ncaa_basketball__ncaa_basketball_IB-_u4gW3ds_1080p, ncaa_basketball__ncaa_basketball_WFl3V7ZY4ss, ncaa_basketball__ncaa_basketball_sRtHQbywiTE

GAP G78B | sport tennis | worktree a3 | log cx_g78b_resolve_uncertain  (CHUNK of G78 -- ONE CLIP ONLY)
...
**YOUR CLIP IS `tennis__tennis_09.mp4` AND NOTHING ELSE. It has 32 uncertain rows.**
WRITE YOUR RESULTS INCREMENTALLY to
docs/evidence/tracking/g65_ball_labels/resolved/tennis__tennis_09.csv, flushing after every 10 rows.

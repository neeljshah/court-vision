...
PREMISE (step 0): confirm cpcv_engine.py and walkforward.py are still byte-identical to the S268 memo's recorded
  ...
  _losses.csv, 310,350 lines, cols record_type/game_id/season/game_date/split_id/n_ticks/loss_candidate_sum/
...
ACCEPTANCE RULE (the verifier applies exactly this and nothing else):
  ...
  n             = 310,350 archived CSV rows / 1,593 games (>= 30)
...
NON-TAUTOLOGY: the replay uses every one of the 310,350 archived rows, not a favorable subset; a log_loss that

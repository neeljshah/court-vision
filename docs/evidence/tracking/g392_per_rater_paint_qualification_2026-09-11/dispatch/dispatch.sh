#!/bin/bash
# usage: dispatch.sh <rater> <codex_home> <set>   set = practice | qualification
R="$1"; HOME_DIR="$2"; SET="$3"
CACHE=/c/Users/neelj/AppData/Local/Temp/g392_work
WT=C:/Users/neelj/nba-track-a13
...
EVID="$WT/docs/evidence/tracking/g392_per_rater_paint_qualification_2026-09-11"
...
for B in "$CACHE/batch_${SET}_${R}"/batch_*.tsv; do
  ...
  gate
  LOG="C:/Users/neelj/AppData/Local/Temp/cx_g392_rater_${R}_${SET}${NN}.log"
  ...
  python /c/Users/neelj/bin/hidden_launch2.py --log "$LOG" --cwd "$WT" --tag "g392_rater_${R}_${SET}${NN}" \

...
OUTDIR="$WT/.g392_out/corrections"
mkdir -p "$OUTDIR"
gate() {
  while true; do
...
gate
LOG="C:/Users/neelj/AppData/Local/Temp/cx_g392_rater_${R}_correction01.log"
...
python /c/Users/neelj/bin/hidden_launch2.py --log "$LOG" --cwd "$WT" --tag "g392_rater_${R}_correction01" \

...
**What's validated:** The pregame prop stack reads these profiles as feature inputs and delivers competitive **leak-free prop accuracy** (WF MAE PTS ~4.83 / REB ~1.92 / AST ~1.39 / FG3M ~0.89, re-measured 2026-07-20 on the grown corpus; earlier smaller-corpus figures were 4.58/1.90/1.34/0.88). Vs real closing lines the market is efficient (break-even-minus-vig; no dollar/ROI edge is claimed -- the earlier "AST ~+4–5% durable edge" is retracted 2026-07-21 as regime-dependent). We **cannot** attribution-test individual intelligence artifacts cleanly at this scale, and CV-derived features currently carry SHAP ≈ 0 in the production models — the layer is a credible, fully-plumbed substrate, **not yet a measured edge**. *(An earlier "+18.38% ROI" attribution here was a market-follow grading artifact, retracted — see [JOB_EVIDENCE_PACKET.md](JOB_EVIDENCE_PACKET.md).)*

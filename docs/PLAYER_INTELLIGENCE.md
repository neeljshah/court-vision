...
**What's validated:** The pregame prop stack reads these profiles and delivers **+18.38% ROI on 1,535 real-close bets** (Kelly-B + isotonic sizing, DK/FD/MGM/Pinnacle OOF). The intelligence layer is part of what drives that — but we can't attribution-test individual artifacts cleanly at this scale.

...
The NBA system took months and 5,504 commits to reach production quality. A naive port to a second sport would cost another several months each -- because the machinery would be rebuilt from scratch every time.

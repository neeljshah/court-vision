...
#   from scripts.platform.validate_adapter import Status, CheckResult
from scripts.platform.validate_adapter_types import (  # noqa: F401
    CheckResult,
    Status,
)

# Internal check helpers
from scripts.platform.validate_adapter_checks import (

"""scripts.platform.proof_soccer.run_proof — CLI entry point for the soccer proof.
...
from scripts.platform.proof_soccer.proof_runner import run_v1, run_v2, run_v3, run_v4

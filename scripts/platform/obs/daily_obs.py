...
Usage (CLI)::
    ...
    python scripts/platform/obs/daily_obs.py          # dry-run: print JSON
    python -m scripts.platform.obs.daily_obs           # same via module

Importable API::

    from scripts.platform.obs.daily_obs import build_daily_report

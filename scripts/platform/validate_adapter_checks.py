"""scripts/platform/validate_adapter_checks.py — Individual check functions.
...
Not intended to be imported by callers outside scripts/platform/.
"""
...
from scripts.platform.validate_adapter_types import CheckResult, Status

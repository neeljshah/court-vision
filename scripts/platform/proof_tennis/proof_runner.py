...
Delegates to the sport-blind generic harness in scripts.platform.proof_common
(platform-harness promotion, W-PROOFSWAP-002)."""
from __future__ import annotations

from scripts.platform.proof_tennis.spec import SPEC
from scripts.platform.proof_common import paper as _paper, runner as _runner

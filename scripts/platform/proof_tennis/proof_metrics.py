"""scripts.platform.proof_tennis.proof_metrics — Pure metric functions for the tennis proof.
...
def isotonic_calibrate(
    ...
    Parameters
    ----------
    train_p:  raw probabilities for the training season.
    train_y:  binary outcomes for the training season.
    eval_p:   raw probabilities for the held-out evaluation season.

"""scripts.platform.proof_common.runner — sport-blind V1 / V2 / V3 proof harness.

Parameterised entirely by a :class:`~scripts.platform.proof_common.spec.ProofSpec`
...
from scripts.platform.proof_common.spec import EvalWindow, ProofSpec

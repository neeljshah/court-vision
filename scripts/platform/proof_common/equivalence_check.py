...
_DISPATCH: Dict[str, Dict[str, Any]] = {
    "tennis": {
        ...
        "old_module": "scripts.platform.proof_tennis.proof_runner",
        "spec_module": "scripts.platform.proof_tennis.spec",
    },
    "soccer": {
        "corpus_subdir": "soccer",
        "builder": _build_soccer_adapter,
        "old_module": "scripts.platform.proof_soccer.proof_runner",
        "spec_module": "scripts.platform.proof_soccer.spec",
    },
    "mlb": {
        "corpus_subdir": "mlb",
        "builder": _build_mlb_adapter,
        "old_module": "scripts.platform.proof_mlb.proof_runner",
        "spec_module": "scripts.platform.proof_mlb.spec",
    },
}
...
def run_equivalence(sport: str, league_filter: Optional[str] = None) -> bool:
    ...
    from scripts.platform.proof_common import runner, paper

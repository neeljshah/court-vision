"""G50B regression: thin reports withhold sample-derived metrics."""
import pandas as pd
...
def test_g50b_nulls_thin_metrics_with_insufficient_data_verdict() -> None:
    """Exercise below, at, and above the frame floor plus the two-frame case."""
    expected_passed = {2: False, MIN_FRAMES_FOR_METRICS - 1: False,

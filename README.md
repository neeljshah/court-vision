...
Each gap is a candidate signal. The agentic research system's job is to validate which ones survive out-of-sample, retire those that decay, and discover gaps 165 and beyond — the path from 75 trained signals toward the 500–5000 signal universe.

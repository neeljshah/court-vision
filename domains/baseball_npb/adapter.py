...
class NPBAdapter:
    ...
    # can drive the bet board / paper channel for NPB. Delegates straight to
    # baseline_probability/Elo -- NO new model logic, no score-distribution
    # fabrication (NPB has no runs model yet, so to_jd() is deliberately NOT
    # implemented; predictor_jd.get_demo_jd degrades to None for npb, the
    ...
    def predict(self, home: str, away: str) -> Dict:
        ...
        return {
            ...
            "honest_note": (
                "NPB pregame = leak-free Elo win-prob (baseline_probability), "

...
from domains.basketball_nba.profiles.player_box_shooting import build_all_player_box_shooting_rows
from domains.basketball_nba.profiles.player_box_splits import build_all_player_box_split_rows
...
def build(seasons: list[str] = SEASONS, out_dir=_OUT_DIR) -> dict[str, pd.DataFrame]:
    player_rows = (
        ...
        + build_all_player_box_shooting_rows(seasons) + build_all_player_box_split_rows(seasons)
    )
    team_rows = (

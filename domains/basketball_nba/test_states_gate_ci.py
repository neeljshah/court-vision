"""Per-file tests for states_gate_ci.py (LANE 2: game-clustered bootstrap CI
+ v2 SUPPORTED survival verdict on the NBA states-gate cross-fit deltas).
PORTED from domains/basketball_wnba/test_states_gate_ci.py.
...
and the SUPPORTED/CI_INCLUDES_ZERO/MIXED/NO_IMPROVEMENT/INSUFFICIENT
survival logic.

Run: cd /c/Users/neelj/nba-ai-system && python -m pytest domains/basketball_nba/test_states_gate_ci.py -q
"""
from __future__ import annotations

from typing import List

from domains.basketball_nba.states_gate import CheckpointCrossfitResult, Row, crossfit_checkpoint_feature
from domains.basketball_nba.states_gate_ci import bootstrap_delta_ci, crossfit_with_ci
...
# ---------------------------------------------------------------------------
# label (states_gate.py verdict)
# ---------------------------------------------------------------------------


def test_verdict_label_is_lower_brier_both_directions():
...
def test_bootstrap_delta_ci_resamples_whole_games_not_rows():
    ...
    game's rows) bootstraps to a valid CI whether or not duplicate

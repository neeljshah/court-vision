...
- **artifact link**: none yet -- UNTESTED, no validator built this lane. Existing receipt for the base metric: `data/cache/intel_claims/mlb_framing_claims.jsonl` (2023/2024 per-catcher rankings, `catcher_id`-keyed, n>=500 floor already applied there).

...
- **artifact link**: `domains/mlb/knowledge/validate_research_wave2.py::catcher_framing_multiseason_trend`; ledger rows `catcher_framing_multiseason_trend` in `domains/mlb/knowledge/validation_ledger.jsonl` (run_ts 2026-07-10T09:43:14Z is the final league-adjusted verdict; an earlier same-session run_ts 09:41:38Z shows the superseded raw/confounded CONFIRMED_LOCAL, kept for audit trail on this append-only ledger). Existing receipt for the base metric: `data/cache/intel_claims/mlb_framing_claims.jsonl` (2023/2024 per-catcher rankings, `catcher_id`-keyed, n>=500 floor already applied there).

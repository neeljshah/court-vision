"""domains.basketball_wnba.states_gate_ci -- LANE 4 game-clustered bootstrap CI
on the states-gate cross-fit deltas (direct-review advisory hardening).
...
uncertainty. At n~40-80 games/half a point comparison can flip on noise. This
...
Per-file test:
  cd /c/Users/neelj/nba-ai-system && python -m pytest domains/basketball_wnba/test_states_gate_ci.py -q
"""
...
from domains.basketball_wnba.states_gate import CheckpointCrossfitResult, Row, _predict_with_term

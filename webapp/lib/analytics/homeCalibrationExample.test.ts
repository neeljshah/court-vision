...
describe("buildHomeCalibrationExample", () => {
  it("selects the largest readable mid-probability MLB model bin and rounds display fields", () => {
    ...
    expect(example).toEqual({ bin_lo: 0.5, bin_hi: 0.6, mean_p: 0.5436, mean_y: 0.4619, n: 17652, n_games: 186, mean_y_ci: [0.3685, 0.5575], gap: -0.0818, gap_ci: [-0.1736, 0.0137], ci_pct: [2.5, 97.5], cluster_unit: "game_id", n_boot: 1000, artifact_date: "2026-07-23", integrity_status: "regenerated" });
  });

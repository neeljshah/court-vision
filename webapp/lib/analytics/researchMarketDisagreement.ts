...
export function buildMarketDisagreementResearch(source: MarketDisagreementSource): ResearchAnalysis[] {
  ...
  return [{
    ...
    rows: analysisRows,
    formula: "Each row copies Model Brier, Market Brier, Model closer rate, and Scored rows from the published absolute model-probability-minus-market-probability bucket.",

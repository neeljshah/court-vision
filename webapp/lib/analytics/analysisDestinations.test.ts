...
describe("analysis destinations", () => {
  it("points only to fixed inspector routes and published source modules", () => {
    ...
    const routes = new Set(["/analytics/calibration", "/analytics/state-reliability", "/analytics/pitch-sequencing", "/analytics/score-decomposition", "/analytics/observation-dependence", "/analytics/residual-anatomy", "/analytics/blowout-timing", "/analytics/state-contrasts", "/analytics/cross-sport-comparability", "/analytics/count-context"]);

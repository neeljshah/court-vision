...
export const ATLAS_FIELD_DEFINITIONS: Record<string, Record<string, AtlasFieldDefinition>> = {
  ...
  nba_players: {
    career_ast_per36: definition("career_ast_per36", "Assists per 36 minutes, corpus seasons", "per36", 1),
    career_fg_pct: definition("career_fg_pct", "Field-goal percentage, corpus seasons", "percent-already", 1),
    career_fg3_pct: definition("career_fg3_pct", "Three-point percentage, corpus seasons", "percent-already", 1),
    career_ft_pct: definition("career_ft_pct", "Free-throw percentage, corpus seasons", "percent-already", 1),
    career_games: definition("career_games", "Games played, corpus seasons", "games", 0),
    career_minutes: definition("career_minutes", "Minutes played, corpus seasons", "minutes", 1),
    career_pts_per36: definition("career_pts_per36", "Points per 36 minutes, corpus seasons", "per36", 1),
    career_reb_per36: definition("career_reb_per36", "Rebounds per 36 minutes, corpus seasons", "per36", 1),
    player_id: definition("player_id", "Player identifier", "text", 0, { isIdentifier: true }),
    seasons_played: definition("seasons_played", "Seasons in corpus", "count", 0),
  },
  nba_teams: {
  ...
  tennis: {
    ...
    grass_adapt_career: definition("grass_adapt_career", "Grass minus overall win rate, career", "fraction-as-percent", 1, { isDifference: true }),
    grass_adapt_recent: definition("grass_adapt_recent", "Grass minus overall win rate, recent", "fraction-as-percent", 1, { isDifference: true }),

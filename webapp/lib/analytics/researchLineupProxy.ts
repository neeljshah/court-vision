...
export function buildLineupProxyResearch(source: LineupProxySource): ResearchAnalysis[] {
  ...
  return [{
    ...
    rows: analysisRows,
    formula: "Active-minus-missed is the published delta_win_rate. The displayed half-width is the nonnegative endpoint of the published ci95_offset interval.",

...
function integrityNotice(moduleIds: readonly string[]): string | undefined {
  ...
  return notices.some(notice => notice.status === "withdrawn-pending-regeneration")
    ? "Source integrity: MLB results withdrawn; MLB/soccer under review."
    : "Source integrity: MLB/soccer under review.";
}

...
export function buildBrierSkillScoresResearch(source: BrierSkillScoresSource): ResearchAnalysis[] {
  ...
  return [{
    ...
    rows: analysisRows,
    formula: "Model versus Climatology Brier skill score = 1 - Model Brier / Climatology Brier. Market versus Climatology Brier skill score = 1 - Market Brier / Climatology Brier. Model versus Market Brier skill score = 1 - Model Brier / Market Brier.",

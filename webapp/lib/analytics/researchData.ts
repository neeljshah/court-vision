...
export function getResearchAnalyses(): ResearchAnalysis[] {
  ...
  return [...getBasketballMatchupRangeResearch(), ...getTennisWindowResearch(), ...getBasketballDepthResearch(), ...getMultisportDepthResearch(), ...basketballResearch(), ...multisportResearch(), ...validationResearch()].map(a => ({

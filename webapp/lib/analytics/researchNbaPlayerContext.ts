...
export function buildNbaPlayerContextResearch(source: PlayerContextSources): ResearchAnalysis[] {
  ...
  return [{
    ...
    bindings: [
      ...
      { operand: "q4_rebounds_shift", sourcePath: "nba_q4_shift.reb_shift.*[].shift", valueKey: "q4_rebounds_shift", label: "Q4 rebounds shift per 36" },
      ...
      { operand: "career_points_per36", sourcePath: "atlas_nba_manifest.entries[].key_numbers.career_pts_per36", valueKey: "career_points_per36", label: "Career points per 36" },
      { operand: "career_rebounds_per36", sourcePath: "atlas_nba_manifest.entries[].key_numbers.career_reb_per36", valueKey: "career_rebounds_per36", label: "Career rebounds per 36" },
      { operand: "career_assists_per36", sourcePath: "atlas_nba_manifest.entries[].key_numbers.career_ast_per36", valueKey: "career_assists_per36", label: "Career assists per 36" },
    ],

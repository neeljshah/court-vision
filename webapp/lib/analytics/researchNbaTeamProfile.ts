...
export function buildNbaTeamProfileResearch(source: TeamProfileSources): ResearchAnalysis[] {
  ...
  return [{
    ...
    rows: built.rows,
    formula: "All displayed measurements are copied from their named source fields. Fragility deltas are the two published estimator deltas; no values are combined or rescaled.",

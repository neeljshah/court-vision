    ...
    <header className="cv-intro">
      <div className="cv-intro-copy">
        ...
        {example ? <section className="cv-calibration-example" role="region" aria-label="Published MLB calibration example">
          {example.integrity_status === "withdrawn-pending-regeneration" ? <p style={{ color: "var(--signal-ink)", fontWeight: 600, marginBottom: 12 }}>MLB in-game results are withdrawn pending corpus correction and regeneration. <Link href="/analytics/findings/ingame-join-integrity/">Read the finding.</Link></p> : null}

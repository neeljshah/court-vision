...
export function Research({ rows, sport }: { rows: Mechanism[]; sport: Sport }) {
  ...
  return <Panel title="The research ledger" eyebrow="Inspect the evidence" source="mechanism_ledger_export">
    ...
    <p className="cv-footnote">Source grouping places partial, provisional and failed-replication results in the null/other group. The original verdict is preserved on every record. Local confirmation does not establish causality or a financial edge.</p>
  </Panel>;
}

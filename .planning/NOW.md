...
2. [ADAPTER] WNBA domain adapter | domains/basketball_wnba/ | step ONE is the feasibility probe (dry-run 2026-07-03 verdict recorded below): outcome labels + close capture must be closeable before building; full loop (labels -> close capture -> gate) before KBO/NPB starts.
